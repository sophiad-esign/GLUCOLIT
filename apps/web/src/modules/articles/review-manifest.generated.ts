...
export const reviewArticlesManifest: ReviewArticleManifestItem[] = [
  {
    ...
    titleZh: "睡眠呼吸暂停与前糖尿病：CPAP治疗的新视角",
    titleEn: "Prediabetes and Sleep Apnea: A New Perspective on CPAP Therapy",
    summaryZh:
      "想象一下，你最近经常感到疲倦，晚上打鼾严重，白天精神不振。这可能不仅仅是疲劳那么简单，而是睡眠呼吸暂停的迹象。如果你同时还被诊断为前糖尿病，那么这两者之间的联系可能对你的健康产生重大影响。 前糖尿病是一种代谢状况，如果不加以控制，可能会进展为2型糖尿病。而睡眠呼吸暂停，这种影响全球数亿人的常见睡眠障碍，可能与前糖尿病有着密切的联系。研究表明，睡眠质量差不仅影响日常生活质量，还可能加剧前糖尿病的病情，增加心血管疾病等并发症的风险。因此，了解前糖尿病与睡眠呼吸暂停之间的关系对于制定有效的健康管理策略至关重要。 最新的研究揭示了前糖尿病和睡眠呼吸暂停之间的双向关系。一方面，前糖尿病可能增加睡眠呼吸暂停的风险；另一方面，睡眠呼吸暂停可能通过影响胰岛素敏感性而加剧前糖尿病的病情。研究还发现，使用CPAP（连续气道正压通气）治疗睡眠呼吸暂停可能有助于改善葡萄糖代谢和胰岛素敏感性。然而，目前的研究证据有限，需要更多的研究来确认CPAP治疗对前糖尿病进展的影响。 我们应该如何看待这一发现？首先，虽然前糖尿病和睡眠呼吸暂停之间的联系已经明确，但这种联系的确切机制和影响程度仍需进一步研究。其次，CPAP治疗可能对改善葡萄糖代谢有积极作用，但不应被视为前糖尿病的独立治疗方法。此外，不同个体对CPAP治疗的反应可能不同，因此治疗效果可能因人而异。最后，前糖尿病和睡眠呼吸暂停的管理应综合考虑，包括生活方式的改变和可能的医疗干预，并在考虑任何治疗方法之前咨询医疗专业人员的意见。 对于怀疑自己有睡眠呼吸暂停的前糖尿病读者，建议与医生讨论可能的治疗方案，包括CPAP治疗。同时，改善生活方式，如增加运动和改善饮食习惯，也是管理前糖尿病的重要部分。对于健康科技行业来说，开发和提供工具，帮助监测和管理前糖尿病和睡眠呼吸暂停，可以为患者提供更好的支持。这包括可穿戴设备、移动应用程序和远程医疗咨询等。 总结几点：前糖尿病和睡眠呼吸暂停之间可能存在关联；CPAP治疗可能有助于改善葡萄糖代谢；需要更多的研究来证实这些发现；与医疗服务提供者讨论可能的治疗方法。 你可以带走的重点 - 前糖尿病和睡眠呼吸暂停之间可能存在关联。 - CPAP治疗可能有助于改善葡萄糖代谢。 - 需要更多的研究来证实这些发现。 - 与医疗服务提供者讨论可能的治疗方法。",
    summaryEn:
      "Imagine you've been feeling tired a lot lately, snoring heavily at night, and struggling to stay awake during the day. This might not just be fatigue but a sign of sleep apnea. If you've also been diagnosed with prediabetes, the link between these two conditions could have significant health implications. Prediabetes is a metabolic condition that can progress to type 2 diabetes if not managed. Sleep apnea, a common sleep disorder affecting hundreds of millions worldwide, may have a close relationship with prediabetes. Studies show that poor sleep quality not only affects daily life quality but can also exacerbate prediabetes, increasing the risk of complications like cardiovascular diseases. Understanding the relationship between prediabetes and sleep apnea is crucial for developing effective health management strategies. The latest research reveals a bidirectional relationship between prediabetes and sleep apnea. On one hand, prediabetes may increase the risk of sleep apnea; on the other hand, sleep apnea may exacerbate prediabetes by affecting insulin sensitivity. The study also found that treating sleep apnea with CPAP (continuous positive airway pressure) may help improve glucose metabolism and insulin sensitivity. However, current research evidence is limited, and more studies are needed to confirm the effects of CPAP treatment on the progression of prediabetes. How should we interpret this discovery? First, while the link between prediabetes and sleep apnea is clear, the exact mechanisms and extent of this connection still require further research. Second, CPAP therapy may have a positive effect on improving glucose metabolism but should not be seen as a standalone treatment for prediabetes. Additionally, individual responses to CPAP therapy may vary, so treatment effects can differ from person to person. Lastly, the management of prediabetes and sleep apnea should consider lifestyle changes and possible medical interventions, and consult with healthcare professionals before considering any treatment methods. For prediabetes readers who suspect they have sleep apnea, it is recommended to discuss possible treatment options with a doctor, including CPAP therapy. At the same time, improving lifestyle, such as increasing exercise and improving dietary habits, is also an important part of managing prediabetes. For the health tech industry, developing and providing tools to help monitor and manage prediabetes and sleep apnea can provide better support for patients. This includes wearable devices, mobile applications, and telemedicine consultations. In summary: Prediabetes and sleep apnea may be related; CPAP therapy could improve glucose metabolism; more research is needed to confirm these findings; discuss potential treatments with a healthcare provider. Practical Takeaways - Prediabetes and sleep apnea may be related. - CPAP therapy could improve glucose metabolism. - More research is needed to confirm these findings. - Discuss potential treatments with a healthcare provider. - Original title: Prediabetes and Obstructive Sleep Apnea: A review of the pathophysiological interaction and the role of CPAP. - Authors: Mendonca CA, Rathi KK, Williams AL, Attre A, Salmon A, Mortensen EM et al. - Journal/source: PubMed insulin resistance interventions via PubMed (Sleep medicine) - DOI: [10.1016/j.sleep.2026.109042](https://doi.org/10.1016/j.sleep.2026.109042) - Open-access link: [https://doi.org/10.1016/j.sleep.2026.109042](https://doi.org/10.1016/j.sleep.2026.109042) - Evidence used: PubMed abstract + open-access full-text link - Published or indexed date: 2026-06-27 如需阅读原文，请点击链接获取完整内容。 本站文章基于公开学术文献进行第三方评论，不代表原文作者及出版机构立场。如涉版权问题，请权利人联系下架。",
    bodyZh:
    ...
    originalUrl: "https://doi.org/10.1016/j.sleep.2026.109042",
  ...
  },
  {
    ...
    titleZh: "菲律宾中年和老年人中孤立性收缩期高血压的普遍性及风险因素",
    titleEn:
      "Prevalence and Risk Factors of Isolated Systolic Hypertension Among Middle-Aged and Older Adults in the Philippines",
    summaryZh:
      "想象一下，您是菲律宾的一位中年人，最近开始注意到自己偶尔会头晕，但并未放在心上。然而，一项新研究可能让您对这种看似无害的症状重新评估。孤立性收缩期高血压（ISH），这种常被称为“无声杀手”的疾病，如果不加以治疗，可能会导致严重的心血管并发症。 这项研究发现，在菲律宾中年和老年人中，ISH的患病率为9.1%，这意味着每十个人中就可能有一个人受到影响。年龄、糖尿病、糖尿病前期、高血压家族史、饮酒习惯以及较低的教育水平都是显著的风险因素。这些发现不仅对个人健康至关重要，也为公共卫生干预提供了方向。 研究指出，ISH的患病率与多种因素相关，这提示我们，对于有糖尿病前期或早期代谢风险的人来说，定期的健康检查和维持健康的生活方式对于控制血压至关重要。例如，减少酒精摄入、改善饮食习惯和增加体力活动，都可能有助于降低ISH的风险。 对于健康科技行业而言，这项研究提供了开发针对性健康项目和工具的机会，以协助早期发现和管理ISH。这可能包括开发易于使用的血压监测应用程序，或者提供个性化的生活方式改变指导。 这项研究的局限性在于，它基于二手数据分析，可能存在数据源固有的局限性，且不能从这项观察性研究中推断出因果关系。因此，虽然研究结果为我们提供了宝贵的信息，但在将这些发现应用于实际干预措施时，仍需谨慎。 对于我们普通读者来说，这项研究提醒我们，定期检查血压和保持健康的生活方式是预防ISH的重要步骤。而对于医疗保健提供者而言，了解这些风险因素可以帮助他们为患者提供更有针对性的建议和干预措施。 最后，这项研究为我们提供了几个值得记住的要点：ISH在菲律宾中年和老年人中较为普遍；风险因素包括年龄、糖尿病、糖尿病前期、高血压家族史、饮酒和低教育水平；未经治疗的ISH可能导致严重的心血管并发症；需要有针对性的干预措施，重点关注生活方式的改变。 你可以带走的重点 - ISH在菲律宾中年和老年人中较为普遍。 - 风险因素包括年龄、糖尿病、糖尿病前期、高血压家族史、饮酒和低教育水平。 - 未经治疗的ISH可能导致严重的心血管并发症。 - 需要有针对性的干预措施，重点关注生活方式的改变。",
    summaryEn:
      "Imagine you're a middle-aged Filipino who's recently noticed occasional dizziness but hasn't given it much thought. However, a new study might make you reassess this seemingly harmless symptom. Isolated systolic hypertension (ISH), often referred to as a 'silent killer,' can lead to severe cardiovascular complications if left untreated. This study found that the prevalence of ISH among middle-aged and older Filipinos is 9.1%, meaning one in ten individuals might be affected. Age, diabetes, prediabetes, family history of hypertension, alcohol consumption, and lower levels of education are significant risk factors. These findings are not only crucial for individual health but also provide direction for public health interventions. The study indicates that the prevalence of ISH is associated with multiple factors, suggesting that for those with prediabetes or early metabolic risk, regular health checks and maintaining a healthy lifestyle are vital for controlling blood pressure. Reducing alcohol intake, improving dietary habits, and increasing physical activity could all help lower the risk of ISH. For the health tech industry, this study presents opportunities to develop targeted health programs and tools to assist in the early detection and management of ISH. This might include developing easy-to-use blood pressure monitoring apps or providing personalized guidance on lifestyle changes. The limitations of this study lie in its basis on secondary data analysis, which may have inherent limitations from the data source, and causality cannot be inferred from this observational study. Therefore, while the study provides valuable information, caution is needed when applying these findings to practical interventions. For our readers, this study serves as a reminder that regular blood pressure checks and maintaining a healthy lifestyle are important steps in preventing ISH. For healthcare providers, understanding these risk factors can help them offer more targeted advice and interventions to their patients. Finally, this study provides several key takeaways: ISH is prevalent among middle-aged and older Filipinos; risk factors include age, diabetes, prediabetes, family history of hypertension, alcohol consumption, and low education levels; untreated ISH can lead to severe cardiovascular complications; targeted interventions focusing on lifestyle modifications are needed. Practical Takeaways - ISH is prevalent among middle-aged and older Filipinos. - Risk factors include age, diabetes, prediabetes, family history of hypertension, alcohol consumption, and low education levels. - Untreated ISH can lead to severe cardiovascular complications. - Targeted interventions focusing on lifestyle modifications are needed. - Original title: Prevalence and factors associated with isolated systolic hypertension among middle-aged adults and older Filipinos: a population-based study. - Authors: Parani MSN, Patalen CF, Maniego MLV, Taylo EJV, Dasco MLP, Duante CA - Journal/source: PubMed prediabetes lifestyle intervention via PubMed (Blood pressure) - DOI: [10.1080/08037051.2026.2629094](https://doi.org/10.1080/08037051.2026.2629094) - Open-access link: [https://doi.org/10.1080/08037051.2026.2629094](https://doi.org/10.1080/08037051.2026.2629094) - Evidence used: PubMed abstract + open-access full-text link - Published or indexed date: 2026-06-24 如需阅读原文，请点击链接获取完整内容。 本站文章基于公开学术文献进行第三方评论，不代表原文作者及出版机构立场。如涉版权问题，请权利人联系下架。",
    bodyZh:
    ...
    thumbnail:
      "https://images.unsplash.com/photo-1505751172876-fa1923c5c528?q=80&w=1800&auto=format&fit=crop",
    source:
      "PubMed prediabetes lifestyle intervention via PubMed (Blood pressure)",
    doi: "10.1080/08037051.2026.2629094",
    originalUrl: "https://doi.org/10.1080/08037051.2026.2629094",
  ...
  },
  {
    ...
    titleZh: "代谢性疾病与神经健康：哈萨克斯坦十年纵向研究的新启示",
    titleEn:
      "Metabolic Diseases and Nerve Health: New Insights from a Decade-Long Study in Kazakhstan",
    summaryZh:
      "想象一下，您正坐在医生的办公室里，听到自己被诊断出糖尿病前期。这不仅意味着您需要关注血糖，还可能影响您的神经系统健康。一项来自哈萨克斯坦的长期研究显示，代谢性疾病，尤其是糖尿病，与周围神经病变风险增加有密切关系。这项研究为我们敲响了警钟，提示我们早期干预的重要性。 在快节奏的现代生活中，肥胖和糖尿病等代谢性疾病越发普遍，它们不仅影响心血管健康，还可能损害神经系统。周围神经病变会导致手脚麻木无力，严重影响生活质量。这项研究为我们提供了宝贵的见解，尤其是在中亚地区，对此类代谢问题与神经健康关系的长期研究较少。 哈萨克斯坦的这项十年纵向研究观察了代谢变化与周围神经病变发展的关系。研究发现，糖尿病前期人数显著增加，且许多人最终发展为周围神经病变。糖尿病患者发展为周围神经病变的风险是普通人的九倍，这一发现凸显了代谢健康对神经健康的深远影响。 这项研究的意义在于，它揭示了代谢变化对神经健康的早期影响，并强调了早期干预的必要性。代谢风险因素的早期管理对于降低周围神经病变的风险至关重要，即使在糖尿病前期也是如此。然而，我们也必须认识到这项研究的局限性，包括样本量减少和可能的选择偏差，这些因素可能影响结果的普遍性和可推广性。此外，研究并未提供具体的干预措施或管理策略，这是未来研究需要进一步探讨的领域。 这项研究的发现提醒我们，代谢性疾病的管理不应仅限于糖尿病确诊后，而应从糖尿病前期就开始。这意味着，对于有糖尿病风险的人群，应更加重视生活方式的调整，包括饮食、运动和体重管理，以降低神经病变的风险。 研究还提示，对于已经确诊的糖尿病患者，需要更加积极的代谢控制和神经健康监测，以减少并发症的发生。这可能包括定期的神经功能检查和血糖控制，以及可能的药物治疗。 此外，这项研究的结果也对公共卫生政策制定者提出了挑战，如何在资源有限的情况下，为高风险人群提供有效的预防和干预措施。 对于普通读者来说，这项研究提醒我们，控制体重和监测血糖对于维护神经健康至关重要。建议定期进行血糖检测，并采取健康的生活方式，如均衡饮食和适量运动，以降低发展为糖尿病的风险。 对于健康科技行业而言，这项研究提供了开发早期诊断工具和预防策略的潜在机会，以减少神经病变的负担。可以考虑开发可穿戴设备或移动应用程序，以帮助用户监测血糖水平和生活方式，从而预防神经损伤。 你可以带走的重点 - 代谢性疾病与周围神经病变风险增加有密切关系。 - 糖尿病前期和糖尿病患者发展为神经病变的风险显著增加。 - 早期干预对于降低神经病变风险至关重要。 - 生活方式的改变和血糖监测对于预防神经病变有重要作用。",
    summaryEn:
      "Imagine sitting in a doctor's office, hearing that you have prediabetes. This not only means you need to pay attention to your blood sugar but also that it could affect your nervous system health. A long-term study from Kazakhstan shows that metabolic diseases, especially diabetes, are closely associated with an increased risk of peripheral neuropathy. This study serves as a wake-up call, highlighting the importance of early intervention. In the fast-paced modern life, metabolic diseases such as obesity and diabetes are becoming more common, affecting not only cardiovascular health but also potentially damaging the nervous system. Peripheral neuropathy can lead to numbness and weakness in the hands and feet, severely affecting the quality of life. This study provides valuable insights, especially in Central Asia, where long-term studies on the relationship between metabolic issues and nervous health are scarce. This ten-year longitudinal study from Kazakhstan observed the relationship between metabolic changes and the development of peripheral neuropathy. The study found a significant increase in the number of prediabetes cases, with many eventually developing peripheral neuropathy. The risk of developing neuropathy among diabetics is nine times higher than in the general population, highlighting the profound impact of metabolic health on nerve health. The significance of this study lies in its revelation of the early effects of metabolic changes on nerve health and the necessity for early intervention. Early management of metabolic risk factors is crucial for reducing the risk of peripheral neuropathy, even in the prediabetes stage. However, we must also recognize the limitations of this study, including reduced sample size and potential selection bias, which may affect the generalizability of the results. Additionally, the study did not provide specific intervention measures or management strategies, areas that future research should explore. The findings of this study remind us that the management of metabolic diseases should not be limited to after a diabetes diagnosis but should start from the prediabetes stage. This means that for people at risk of diabetes, it is essential to pay more attention to lifestyle adjustments, including diet, exercise, and weight management, to reduce the risk of neuropathy. The study also suggests that for those who have been diagnosed with diabetes, more aggressive metabolic control and nerve health monitoring are needed to reduce the occurrence of complications. This may include regular nerve function checks and blood sugar control, as well as possible medication. Furthermore, the results of this study pose a challenge to public health policymakers on how to provide effective prevention and intervention measures for high-risk groups under limited resources. For ordinary readers, this study reminds us that controlling weight and monitoring blood sugar are crucial for maintaining nerve health. It is recommended to regularly check blood sugar and adopt a healthy lifestyle, such as a balanced diet and moderate exercise, to reduce the risk of developing diabetes. For the health technology industry, this study provides potential opportunities for developing early diagnostic tools and prevention strategies to reduce the burden of neuropathy. Wearable devices or mobile applications can be considered to help users monitor blood sugar levels and lifestyles, thereby preventing nerve damage. Practical Takeaways - Metabolic diseases are closely associated with an increased risk of peripheral neuropathy. - Prediabetes and diabetes significantly increase the risk of developing neuropathy. - Early intervention is crucial for reducing the risk of neuropathy. - Lifestyle changes and blood sugar monitoring play an important role in preventing neuropathy. - Original title: Longitudinal assessment of metabolic and neurological decline in peripheral polyneuropathy over ten years. - Authors: Azizkhojayeva D, Nuskabayeva G, Sadykova K, Turmanbayeva A, Kaldarkhan D, Mombekov N et al. - Journal/source: PubMed diabetes prevention and remission via PubMed (Future science OA) - DOI: [10.1080/20565623.2026.2665758](https://doi.org/10.1080/20565623.2026.2665758) - Open-access link: [https://europepmc.org/articles/PMC13154949](https://europepmc.org/articles/PMC13154949) - Evidence used: PubMed abstract + PubMed Central open full-text excerpt + open-access full-text link - Published or indexed date: 2026-06-20 如需阅读原文，请点击链接获取完整内容。 本站文章基于公开学术文献进行第三方评论，不代表原文作者及出版机构立场。如涉版权问题，请权利人联系下架。",
    bodyZh:
  ...
  },
  {
    ...
    titleZh: "北京工作人群糖尿病前期进展风险研究",
    titleEn:
      "Study on the Risk of Progression from Prediabetes to Diabetes Among Working Population in Beijing",
    summaryZh:
      "在北京这座繁忙的大都市中，许多上班族因为工作压力、不规律饮食和久坐不动的生活方式而面临健康风险。糖尿病前期，这个听起来并不严重的医学术语，实际上可能是糖尿病的前奏。最近，一项名为“同仁健康研究”的研究为我们敲响了警钟，揭示了北京工作人群中糖尿病前期进展为糖尿病的风险。 这项研究的重要性在于，它提供了从糖尿病前期到糖尿病的进展率的宝贵数据，这对于制定针对性的预防策略和公共卫生政策至关重要。研究发现，23.9%的正常人最终发展为糖尿病前期，而2.3%的人发展为糖尿病。在糖尿病前期人群中，28.0%最终发展为糖尿病，而18.7%的人血糖水平恢复正常。值得注意的是，年轻成年人的进展率相对较低。 这项研究的发现告诉我们，糖尿病前期是发展为糖尿病的一个重要风险因素，尤其是在年轻成年人中。生活方式的改变，如增加运动、改善饮食习惯，可以预防或延缓从糖尿病前期到糖尿病的进展。 然而，这项研究也存在局限性。由于是观察性研究，不能确定因果关系。此外，研究没有提供特定干预措施的有效性数据。因此，我们不能简单地将进展率归因于某种特定的生活方式改变。 尽管如此，这项研究的结果仍然为我们提供了宝贵的启示。我们需要针对不同年龄段的预防策略来应对糖尿病进展的风险。对于年轻成年人，可能需要更多的健康教育和生活方式指导，而对于年长者，则可能需要更积极的医疗干预。 健康科技也可以在这一过程中发挥作用。通过跟踪血糖水平和提供个性化建议，健康科技可以帮助个体更好地管理他们的糖尿病前期。 总之，这项研究提醒我们，糖尿病前期是一个不容忽视的健康问题。通过积极的生活方式改变和适当的医疗干预，我们可以降低糖尿病的风险。同时，我们也需要更多的研究来探索不同人群的预防策略，以实现更精准的健康管理。 你可以带走的重点 - 糖尿病前期是发展为糖尿病的一个重要风险因素，尤其是在年轻成年人中。 - 生活方式的改变可以预防或延缓从糖尿病前期到糖尿病的进展。 - 需要针对不同年龄段的预防策略来应对糖尿病进展的风险。 - 健康科技可以通过跟踪和个性化建议支持个体管理他们的糖尿病前期。 - 这项研究提醒我们，糖尿病前期是一个不容忽视的健康问题。",
    summaryEn:
      "In the bustling city of Beijing, many office workers face health risks due to work stress, irregular meals, and sedentary lifestyles. Prediabetes, a medical term that doesn't sound serious, could actually be a prelude to diabetes. A recent study, known as the Tongren HealthCare Study, has sounded an alarm, revealing the risk of progression from prediabetes to diabetes among working adults in Beijing. The significance of this study lies in its provision of valuable data on the progression rates from prediabetes to diabetes, which is crucial for developing targeted prevention strategies and public health policies. The study found that 23.9% of individuals with normal blood sugar eventually developed prediabetes, while 2.3% developed diabetes. Among those with prediabetes, 28.0% eventually developed diabetes, while 18.7% normalized their blood sugar levels. Notably, younger adults had relatively lower progression rates. The findings of this study tell us that prediabetes is a significant risk factor for developing diabetes, especially among younger adults. Lifestyle changes, such as increasing exercise and improving dietary habits, can prevent or delay the progression from prediabetes to diabetes. However, the study also has its limitations. As an observational study, it cannot establish causation. Additionally, the study does not provide data on the effectiveness of specific interventions. Therefore, we cannot simply attribute the progression rates to a particular lifestyle change. Nevertheless, the results of this study still provide valuable insights. We need prevention strategies tailored to different age groups to address the risk of diabetes progression. For younger adults, more health education and lifestyle guidance may be needed, while older individuals may require more aggressive medical interventions. Health technology can also play a role in this process. By tracking blood sugar levels and providing personalized advice, health technology can help individuals better manage their prediabetes. In summary, this study reminds us that prediabetes is a health issue that should not be ignored. Through proactive lifestyle changes and appropriate medical interventions, we can reduce the risk of diabetes. At the same time, we also need more research to explore prevention strategies for different populations to achieve more precise health management. Practical Takeaways - Prediabetes is a significant risk factor for developing diabetes, especially among younger adults. - Lifestyle changes can prevent or delay the progression from prediabetes to diabetes. - There is a need for age-specific prevention strategies to address the risk of diabetes progression. - Health technology can support individuals in managing their prediabetes through tracking and personalized advice. - This study reminds us that prediabetes is a health issue that should not be ignored. - Original title: Prediabetes, diabetes, and the risk of progression to diabetes among working population in Beijing-the Tongren HealthCare Study. - Authors: Li Y, Liu W, Zeng X, Cui J, Chen D, Wang Y et al. - Journal/source: PubMed prediabetes lifestyle intervention via PubMed (PloS one) - DOI: [10.1371/journal.pone.0343993](https://doi.org/10.1371/journal.pone.0343993) - Open-access link: [https://europepmc.org/articles/PMC13189350](https://europepmc.org/articles/PMC13189350) - Evidence used: PubMed abstract + PubMed Central open full-text excerpt + open-access full-text link - Published or indexed date: 2026-01-01 如需阅读原文，请点击链接获取完整内容。 本站文章基于公开学术文献进行第三方评论，不代表原文作者及出版机构立场。如涉版权问题，请权利人联系下架。",
    bodyZh:
    ...
    originalUrl: "https://europepmc.org/articles/PMC13189350",
    publishedAt: "2026-01-01",
    publishedAtLabel: "2026-01-01",
    draft: true,
    reviewRequired: true,
