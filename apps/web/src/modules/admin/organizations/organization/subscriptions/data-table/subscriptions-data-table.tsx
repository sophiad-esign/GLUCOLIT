...
import { useColumns } from "~/modules/admin/users/user/subscriptions/data-table/columns";
...
export const SubscriptionsDataTable = ({
  organizationId,
  ...
  const { table, query } = useDataTable({
    ...
    query: ({ page, perPage, sorting, filters }) =>
      admin.queries.organizations.getSubscriptions({
        id: organizationId,
        page: page.toString(),
