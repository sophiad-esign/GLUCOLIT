...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="border-b px-1 pb-0">
      <InputGroup className="h-10! gap-0.5 rounded-lg! border-none shadow-none! dark:bg-transparent">
